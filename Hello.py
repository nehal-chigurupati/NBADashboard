...
msg = """
My name is Nehal, I'm a data scientist at Utah's front office. I built this streamlit app to display some projects I worked on during college at UVA. Feel free to reach
...
with st.expander(label="Predicting the length of three-point slumps", expanded=False):
    ...
    and to evaluate strategies for overcoming such slumps. To make these determinations,
      I applied techniques from survival analysis, a method commonly used in medical studies to assess mortality risks.
